...
#+RESULTS:
: # Out[47]:
: : RecordMetadata(topic='crawler-requests', partition=3, topic_partition=TopicPartition(topic='crawler-requests', partition=3), offset=46, timestamp=1606610288099, checksum=1847456359, serialized_key_size=-1, serialized_value_size=60, serialized_header_size=-1)

...
#+RESULTS:
: # Out[111]:
: : RecordMetadata(topic='crawler-requests', partition=3, topic_partition=TopicPartition(topic='crawler-requests', partition=3), offset=28, timestamp=1606594759319, checksum=2303985319, serialized_key_size=-1, serialized_value_size=50, serialized_header_size=-1)

...
#+RESULTS:
: # Out[81]:
: : RecordMetadata(topic='crawler-requests', partition=2, topic_partition=TopicPartition(topic='crawler-requests', partition=2), offset=16, timestamp=1606590828779, checksum=139545095, serialized_key_size=-1, serialized_value_size=118, serialized_header_size=-1)

...
#+RESULTS:
: # Out[48]:
: : RecordMetadata(topic='crawler-requests', partition=0, topic_partition=TopicPartition(topic='crawler-requests', partition=0), offset=33, timestamp=1606610293687, checksum=3677142993, serialized_key_size=-1, serialized_value_size=50, serialized_header_size=-1)

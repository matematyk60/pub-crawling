...
#+RESULTS:
: # Out[57]:
: : RecordMetadata(topic='crawler-requests', partition=3, topic_partition=TopicPartition(topic='crawler-requests', partition=3), offset=7, timestamp=1606585213182, checksum=2454809059, serialized_key_size=-1, serialized_value_size=65, serialized_header_size=-1)
